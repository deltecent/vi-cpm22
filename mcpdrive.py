...
class AltairSim:
    ...
    Typical use::
        ...
        with AltairSim("vi.toml", cwd=HERE, disk="CPM22-8MB-56K-VI.DSK") as sim:
    ...
    def __init__(
        ...
        **_ignored,          # swallow kwargs that don't apply under --mcp (e.g. wru)
        ...
        self.steps = 0            # instructions executed across every run slice
    ...
    def _run(self, input=None, from_pc=None, until=None, timeout_ms=None):
        ...
        self.steps += r.get("steps", 0) or 0   # accumulate 8080 instructions run
        return r
